...
create table Supply_to_stay( id int primary key auto_increment, quantity int not null, supply_id int not null, constraint fk_sts_supply_id foreign key (supply_id) references Supply(id) on delete restrict, stay_id int not null, constraint fk_sts_stay_id foreign key (stay_id) references Stay(id) on delete restrict);
...
insert into Supply_to_stay(quantity, supply_id, stay_id) values (1, 1, 1);
insert into Supply_to_stay(quantity, supply_id, stay_id) values (2, 1, 2);
insert into Supply_to_stay(quantity, supply_id, stay_id) values (2, 1, 3);
insert into Supply_to_stay(quantity, supply_id, stay_id) values (3, 1, 1);
